...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, storeName string) {
    ...
    r.HandleFunc(fmt.Sprintf("/%s/oracle/send_verf_code/{%s}", storeName, "mobile"), oracleSendVerfCode(cliCtx, storeName)).Methods("GET")
    ...
    r.HandleFunc(fmt.Sprintf("/%s/oracle/nft/user/all/token_record/{%s}", storeName,"tel"), nftUserAllTokenRecord(cliCtx, storeName)).Methods("GET")
    r.HandleFunc(fmt.Sprintf("/%s/oracle/nft/user/invite/token_record/{%s}", storeName,"tel"), nftUserInvitationRecord(cliCtx, storeName)).Methods("GET")
