...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, storeName string) {
    ...
    r.HandleFunc(fmt.Sprintf("/%s/application-user-file-volume-limit/{%s}/{%s}", storeName, "accessToken", "appCode"), showApplicationUserFileVolumeLimit(cliCtx, storeName)).Methods("GET")
    r.HandleFunc(fmt.Sprintf("/%s/application-user-used-file-volume/{%s}/{%s}", storeName, "accessToken", "appCode"), showApplicationUserUsedFileVolume(cliCtx, storeName)).Methods("GET")
    ...
    r.HandleFunc(fmt.Sprintf("/%s/tables_detail/{%s}/{%s}", storeName, "accessToken", "appCode"), showTablesDetailHandler(cliCtx, storeName)).Methods("GET")
    r.HandleFunc(fmt.Sprintf("/%s/table_detail/{%s}/{%s}/{%s}", storeName, "accessToken", "appCode","tableName"), showTableDetailHandler(cliCtx, storeName)).Methods("GET")
    ...
    r.HandleFunc(fmt.Sprintf("/%s/table-associations/{%s}/{%s}/{%s}", storeName, "accessToken", "appCode", "tableName"), showTableAssociationsHandler(cliCtx, storeName)).Methods("GET")
    ...
    r.HandleFunc(fmt.Sprintf("/%s/call-dynamic-script/{%s}/{%s}/{%s}", storeName, "accessToken", "appCode", "script"), showCallDynamicScriptHandler(cliCtx, storeName)).Methods("GET")
    ...
    r.HandleFunc(fmt.Sprintf("/%s/groups_detail/{%s}/{%s}", storeName, "accessToken", "appCode"), showGroupsDetail(cliCtx, storeName)).Methods("GET")
