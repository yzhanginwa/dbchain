...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, storeName string) {
    ...
    r.HandleFunc(fmt.Sprintf("/%s/can_add_column_data_type/{%s}/{%s}/{%s}/{%s}/{%s}", storeName, "accessToken", "appCode", "tableName", "fieldName", "dataType"), showCanAddColumnDataTypeHandler(cliCtx, storeName)).Methods("GET")
