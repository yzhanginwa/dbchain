...
func RegisterCodec(cdc *codec.Codec) {
    cdc.RegisterConcrete(MsgCreateApplication{}, "cosmosapi/CreateApplication", nil)
    cdc.RegisterConcrete(MsgAddDatabaseUser{}, "cosmosapi/AddDatabaseUser", nil)
    ...
    cdc.RegisterConcrete(MsgModifyColumnOption{}, "cosmosapi/ModifyColumnOption", nil)
    ...
    cdc.RegisterConcrete(MsgRespondFriend{}, "cosmosapi/RespondFriend", nil)
}
